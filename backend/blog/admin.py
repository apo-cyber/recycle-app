...
class BlogPostAdmin(admin.ModelAdmin):
    ...
    list_filter = ["is_published", "is_sold_out", "created_at", "tags"]
    ...
    fieldsets = (
        ("基本情報", {"fields": ("title", "author", "description")}),
        ("画像とタグ", {"fields": ("image", "tags")}),
        ("公開設定", {"fields": ("is_published", "is_sold_out", "published_at")}),
...
class CommentAdmin(admin.ModelAdmin):
    ...
    def get_queryset(self, request):
        return (
            ...
            .select_related("author", "blog_post", "parent", "parent__author")
        )
